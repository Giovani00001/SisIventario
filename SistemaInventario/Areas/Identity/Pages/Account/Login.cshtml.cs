    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var usuario = await _unidadTrabajo.UsuarioAplicacion.ObtenerPrimero(p => p.UserName == Input.Email);
                    ...
                    HttpContext.Session.SetInt32(Ds.ssCarroCompras, numProd);
                ...
                {
                    ModelState.AddModelError(string.Empty, "Usuario incorrecto o no esta registrado o no confirmado.");
                    return Page();
                }
            }
